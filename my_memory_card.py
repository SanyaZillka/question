...
question_list = []
q1= Question('Сколько ног у воздушного шарика?','8','12','84','может быть')
question_list.append(q1)
q2=Question('Почему тумбочка не пылесос?','да','нет','пылесос','казахстан угражает нам бомбардировкой')
question_list.append(q2)
q3=Question('муравейник или жук плавунец?','ага','кринж','муравейник','жук')
question_list.append(q3)
q4=Question('как съесть холодильник?','никак','с майонезом','без майонеза','он не вкусный')
question_list.append(q4)
q5=Question('какого цвета оранжевый кирпич?','голубого','синего','цвета морской волны','небесного')
question_list.append(q5)
q6=Question('трубочист чистит труб, а я?','код','нет','провода','98')
question_list.append(q6)
q7=Question('больше вопросов не будет?','да','нет','крокодил','98')
question_list.append(q7)
q8=Question('корова му, а лось?','нет','иа','да','дизоксирибонуклиотическая кислота')
